...
class Config:
    def __init__(self):
        ...
        self.API_ID: int = int(getenv("34175180", "0"))
        self.API_HASH: str = getenv("54e664524248ecc195bd3d731725396d", "")

        # BOT CONFIGURATION
        self.BOT_TOKEN: str = getenv("8974679127:AAFXY5MvPGqzG2W7E8pH5gPGRGQV06ZA-a0", "")
